...
function AppInfo() {
  ...
  return (
    <>
      ...
      { ['Home', 'Training', 'Maxes', 'Programs'].includes(page) && <Navbar users={users} page={page} setPage={setPage} show={show} setShow={setShow} showNewMax={showNewMax} setShowNewMax={setShowNewMax}/>}
      <img 
        src={settings_button} 
        alt="settings" 
        id='settings-button'
